...
// Index global (1-based) sebuah ikan di katalog + total ikan.
const FISH_INDEX = {}
FISH.forEach((f, i) => (FISH_INDEX[f.id] = i + 1))
export const FISH_TOTAL = FISH.length

/** Nomor index ikan (1-based) di katalog, atau 0 bila tidak ditemukan. */
export function fishIndex(fishId) {
    return FISH_INDEX[fishId] || 0
}
