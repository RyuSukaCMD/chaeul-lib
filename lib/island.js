...
const WEATHERS_LABELS = { shark_hunter: "Shark Hunter" }
...
const ISLAND_FISH = {
    ...
    // Shark Island — hanya terlihat saat weather Shark Hunter aktif.
    shark_island: [
        ["Reef Shark", "common", "🦈"],
        ["Hammerhead Pup", "common", "🔨"],
        ["Blue Shark", "common", "🔵"],
        ["Tiger Shark", "common", "🐯"],
        ["Nurse Shark", "common", "🩺"],
        ["Mako Shark", "uncommon", "⚡"],
        ["Bull Shark", "uncommon", "🐂"],
        ["Thresher Shark", "uncommon", "🌊"],
        ["Goblin Shark", "rare", "👺"],
        ["Megamouth Shark", "rare", "😮"],
        ["Leopard Shark", "rare", "🐆"],
        ["Sawshark", "rare", "🪚"],
        ["Hammerhead Prime", "epic", "🔨"],
        ["Great White", "epic", "🦈"],
        ["Megalodon", "epic", "🦷"],
        ["Abyss Shark", "epic", "🌑"],
        ["Void Shark", "epic", "🕳️"],
        ["Eclipse Shark", "epic", "🌘"],
        ["Ancient Megalodon", "legendary", "🏺"],
        ["Leviathan Shark", "legendary", "🐉"],
        ["Celestial Shark", "legendary", "🌌"],
        ["Secret Fang", "secret", "🗡️"],
        ["The First Shark", "secret", "👑"],
        ["Shark God", "godly", "☄️"]
    ]
}
...
export const ISLANDS = {
    ...
    shark_island: {
        ...
        name: "Shark Island",
        emoji: "🦈",
        desc: "Wilayah hiu langka. Hanya muncul selama Shark Hunter.",
        stone: false,
        secret: true,
        requiresWeather: "shark_hunter"
    }
}
 ...
 */
export function islandUnlocked(player, island, options = {}) {
    const info = ISLANDS[island]
    if (!info) return false
    if (info.requiresWeather) return options.weather?.[info.requiresWeather] === true
...
export function islandUnlockText(player, island, options = {}) {
    const info = ISLANDS[island]
    if (!info || islandUnlocked(player, island, options)) return "Terbuka"
    if (info.requiresWeather) return `Weather ${WEATHERS_LABELS[info.requiresWeather] || info.requiresWeather} aktif`
