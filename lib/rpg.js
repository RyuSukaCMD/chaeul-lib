...
export const ITEMS = {
    ...
    // Pancing (rod → peluang ikan langka)
    rod: { name: "Pancing Kayu", type: "rod", luck: 1, price: 0, emoji: "🎣" },
    prorod: { name: "Pancing Pro", type: "rod", luck: 2, price: 1500, emoji: "🎏" },

    // Energy
    energydrink: { name: "Minuman Energi", type: "misc", energy: 10, price: 200, emoji: "⚡" }
}

// ─── Katalog Ikan (hasil mancing) ───
// rarity menentukan peluang; price = harga jual
export const FISH = [
    { id: "ikan_teri", name: "Ikan Teri", price: 30, rarity: "common", emoji: "🐟" },
    { id: "ikan_mas", name: "Ikan Mas", price: 60, rarity: "common", emoji: "🐠" },
    { id: "ikan_lele", name: "Ikan Lele", price: 90, rarity: "common", emoji: "🐡" },
    { id: "cumi", name: "Cumi-cumi", price: 150, rarity: "uncommon", emoji: "🦑" },
    { id: "gurita", name: "Gurita", price: 220, rarity: "uncommon", emoji: "🐙" },
    { id: "hiu", name: "Hiu", price: 500, rarity: "rare", emoji: "🦈" },
    { id: "paus", name: "Paus", price: 900, rarity: "rare", emoji: "🐋" },
    { id: "duyung", name: "Putri Duyung", price: 2500, rarity: "legendary", emoji: "🧜‍♀️" }
]

const RARITY_WEIGHT = { common: 60, uncommon: 25, rare: 12, legendary: 3 }

/** Pilih ikan acak (dipengaruhi luck rod). */
export function rollFish(luck = 1) {
    const pool = []
    for (const f of FISH) {
        let w = RARITY_WEIGHT[f.rarity]
        if (f.rarity !== "common") w *= luck // rod bagus menaikkan peluang langka
